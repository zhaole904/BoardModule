//
//  BoardProductMixViewController.swift
//  BoardModule
//
...
class BoardProductMixViewController: OABoardViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = BoardTableViewCell.cellWithTableView(tableView: tableView, styleNum: boardVCtype.productMix.rawValue)
        ...
        if ( indexPath.row == 0) {
            ...
            if (self.dataArr.count > 0) {
                ...
                cell.refreshModel(model: model as! BoardModel, indexPath: indexPath, btnTag: 0, isDetail: false)
